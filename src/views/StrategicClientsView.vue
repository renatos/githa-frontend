    ...
    <div class="filters-card">
      ...
      <div class="status-filters">
        <label v-for="status in statuses" :key="status.value" class="checkbox-label">
          <input type="checkbox" v-model="selectedStatuses" :value="status.value" @change="refresh">
...
.badge.vip { background-color: var(--color-status-vip-bg); color: var(--color-status-vip-text); }
.badge.at_risk { background-color: var(--color-status-risk-bg); color: var(--color-status-risk-text); }
.badge.new { background-color: var(--color-status-new-bg); color: var(--color-status-new-text); }
.badge.active { background-color: var(--color-status-active-bg); color: var(--color-text-muted); }
...
.status-badge.active { background-color: var(--color-status-active-bg); color: var(--color-text-muted); }
