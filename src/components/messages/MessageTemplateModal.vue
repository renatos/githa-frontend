...
const renderedPreview = computed(() => {
  ...
  return form.value.content
    ...
    .replace(/\{cliente\}/g, 'Ana Paula')
    .replace(/\{responsavel_agendamento\}/g, 'Renato')
    .replace(/\{responsavelAgendamento\}/g, 'Renato')
    .replace(/\{criador\}/g, 'Renato')
    .replace(/\{servico\}/g, 'design de sobrancelhas')
    .replace(/\{procedimento\}/g, 'design de sobrancelhas')
    ...
    .replace(/\{dia_semana\}/g, 'sexta-feira')
    .replace(/\{diaSemana\}/g, 'sexta-feira')
